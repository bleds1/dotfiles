...
'("~/Dropbox/roam/archive.org" "~/Dropbox/roam/events.org" "~/Dropbox/roam/goals.org" "~/Dropbox/roam/reading.org" "~/Dropbox/roam/repeat.org" "~/Dropbox/roam/shopping.org" "~/Dropbox/roam/someday.org" "~/Dropbox/roam/tasks.org")))
#+end_src
...
(setq! org-capture-templates
        '(("i" "TODO")
          ("ii" "Todo" entry (file+olp "~/Dropbox/roam/tasks.org" "INBOX")
          "** TODO %?\nCREATED:%U\n")
         ;; ("im" "Mail" entry (file+olp "~/Dropbox/roam/tasks.org" "EMAIL")
         ;; "** TODO %a\nCREATED:%U")
          ("is" "Someday/Maybe" entry (file+olp "~/Dropbox/roam/someday.org" "INBOX")
          "** SOMEDAY %?\nCREATED:%U\n" :empty-lines 1)
          ("ip" "Project" entry (file+olp "~/Dropbox/roam/tasks.org" "INBOX")
          "** PROJECT %?%^{DEADLINE}p\nCREATED:%U\n" :empty-lines 1)
          ("ig" "Goal" plain (file+olp "~/Dropbox/roam/goals.org" "INBOX")
         (file "~/Dropbox/3_Resources/templates/tpl-goals.txt") :empty-lines 1)
          ("n" "Note")
           ("nn" "Quick Note" entry (file+olp "~/Dropbox/roam/tasks.org" "INBOX")
           "** %?\nCREATED:%U\n")
           ("nj" "Journal entry" plain (function org-journal-find-location)
                               "** %(format-time-string org-journal-time-format)\n  - %?")
           ("ni" "Idea" entry (file+olp "~/Dropbox/roam/tasks.org" "INBOX")
           "** IDEA %?\nCREATED:%U\n")
           ("m" "Mail ")
           ("mf" "Follow Up" entry (file+olp "~/Dropbox/roam/tasks.org" "AREA EMAIL")
          "*** TODO Follow up with %:fromname on %a\nSCHEDULED:%t\n\n%i")
           ("mr" "Read Later" entry (file+olp "~/Dropbox/roam/tasks.org" "AREA EMAIL")
          "*** REVIEW Read %:subject\nSCHEDULED:%t\n%a\n\n%i")
