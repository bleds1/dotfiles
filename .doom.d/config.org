...
(setq!
      ...
      org-journal-dir "~/Dropbox/vault/diary/"
...
(after! org
  (setq! org-capture-templates
         '(("t" "Todo" plain (function org-journal-find-location)
            "\n- [ ] %? #TODO" :empty-lines 1)
           ("n" "Journal entry" plain (function org-journal-find-location)
...
;;
;;(setq org-roam-dailies-directory "~/Dropbox/vault/diary/"))
;;
#+end_src
