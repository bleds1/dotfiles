...
** Visual/Theme
I like the base theme of wilmersdorf but I have some custom-set-faces to tweak to my liking here and in custom.el
...
** Org Roam
Org roam directory and capture templates.
...
The zz/function is stolen from [[https://zzamboni.org/post/my-doom-emacs-configuration-with-commentary/][zzamboni.org]] /"Note that this requires lexical binding to be enabled, so that the lambda creates a closure, otherwise the keybindings don’t work."/
...
Make a new org and md buffer easier (from tecosaur.github.io)
...
** Leader Keybinds
Take me to your leader. Convienient keybinds.
...
* Dired
** Dired Keybinds
TODO: Y for cut file isn't working correctly
...
** Simple Dired
I don't need to see all the info columns. I prefer the minimal look a bit like Ranger, I have 'all the icons' here too.
