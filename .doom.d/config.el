...
(setq doom-font (font-spec :family "Adwaita Mono" :size 15)
      doom-big-font (font-spec :family "Adwaita Mono" :size 16)
      doom-serif-font (font-spec :family "Adwaita Mono" :size 15)
      doom-variable-pitch-font (font-spec :family "Adwaita Mono" :size 15))
...
(catppuccin-set-color 'base "#1e1e1e")
(catppuccin-set-color 'mantle "#1e1e1e")
(catppuccin-reload)
