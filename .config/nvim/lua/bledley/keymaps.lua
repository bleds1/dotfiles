...
vim.keymap.set("n", "<leader>vdt", vim.cmd.VimwikiTabMakeDiaryNote)
vim.keymap.set("n", "<leader>vdy", vim.cmd.VimwikiYesterdayDiaryNote)
vim.keymap.set("n", "<leader>vdm", vim.cmd.VimwikiTomorrowDiaryNote)
